...
- `docs/karticky.pdf` – 16 kartiček 99 × 105 mm (6 na A4 na šířku, 3 strany): 12 ke slidům (kam mířím, věta na navázání, opěrná fakta, přechod), 4 k otázkám z posudků. Zdroj `docs/karticky.html`, text `docs/karticky.md`.
